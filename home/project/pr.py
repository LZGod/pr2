...
def plain(text, meta):
    ...
    row = '%s\t%s\t%s\t%s\tпублицистика\tNone\tнейтральный\t\возраст\tуровень\tрайонная\t%s\tАвангард\t\%s\tгазета\tРоссия\tВавожский район\tru'
...
def main():
    ...
    row = 'path\tauthor\theader\tcreated\tsphere\ttopic\tstyle\taudience_age\taudience_level\taudience_size\tsource\tpublication\tpubl_year\tmedium\tcountry\tregion\tlanguage'
